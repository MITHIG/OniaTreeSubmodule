...
[OniaTreeSubmodule](https://github.com/CMS-HIN-dilepton/OniaTreeSubmodule/tree/CMSSW_14_1_X).

> [!NOTE]
> The original instructions can be found here:
> <https://twiki.cern.ch/twiki/bin/view/CMS/HiDileptonWorkingAreaSetting>

1) From lxplus, get a recent CMSSW_14_1_X version:

```bash
cmsRel CMSSW_14_1_9_patch3
cd CMSSW_14_1_9_patch3/src/
cmsenv
```
...
git checkout oniaforest/CMSSW_14_1_X_ForestIntegration HiAnalysis
git checkout oniaforest/CMSSW_14_1_X_ForestIntegration HiSkim
git checkout oniaforest/CMSSW_14_1_X_ForestIntegration HeavyIonsAnalysis
scram b -j8
```
